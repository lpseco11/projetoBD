...
class Employe:
    def __init__(self, employe_id=None, name=None, contact_info=None,password=None, contract_details=None):
    ...
    def auth_fetch(self):
        ...
        query = 'SELECT * FROM employe WHERE name = %s AND password = %s'
